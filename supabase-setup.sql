...
select * from (values
  ('კომოდები', 'dresser', 1),
  ('ტვ სადგამი მაგიდა', 'tv-stand', 2),
  ('საძინებლის კარადები', 'wardrobe', 3),
  ('შემოსასვლელის კარადა', 'entry-cabinet', 4),
  ('მაგიდები', 'table', 5),
  ('ტუალეტის ტრილიაჟი', 'vanity', 6),
  ('საძინებელი', 'bedroom', 7),
  ('საწოლები', 'bed', 8),
  ('ეზოს ავეჯი', 'outdoor', 9),
  ('სკამები და სავარძლები', 'chair', 10),
  ('საოფისე კარადები და თარეები', 'office-storage', 11),
  ('საოფისე სავარძლები', 'office-chair', 12),
  ('თარეები', 'shelf', 13),
  ('ფეხსაცმლის კარადა', 'shoe-cabinet', 14),
  ('სამზარეულო', 'kitchen', 15),
  ('ტვ-ს კედლის კარადა', 'tv-wall-unit', 16),
  ('კედლის თარო', 'wall-shelf', 17)
...
from (values
  ('სკამები და სავარძლები', 'კუთხის დივანი „თბილისი"', 'გამძლე და მოხერხებული კუთხის დივანი, იდეალური საოჯახო სივრცისთვის.', 1690.00, false, 1),
  ('მაგიდები', 'ჟურნალის მაგიდა „ავლაბარი"', 'ხის ჟურნალის მაგიდა თანამედროვე დიზაინით.', 420.00, true, 2),
  ('სკამები და სავარძლები', 'სასადილო სკამი „ვაკე"', 'მოხერხებული და ესთეტიური სასადილო სკამი.', 245.00, false, 3),
  ('საწოლები', 'ორადგილიანი საწოლი „საბურთალო"', 'მყარი კარკასი და მაღალი ხარისხის მასალები.', 1450.00, false, 4),
  ('საძინებლის კარადები', 'კარადა „რუსთაველი"', 'ტევადი კარადა ორი გამწყობი კარით.', 980.00, false, 5),
  ('მაგიდები', 'სამაგიდო ნათურა „ფუნიკულიორი"', 'თბილი განათება სამუშაო თუ დასასვენებელი სივრცისთვის.', 165.00, false, 6)
